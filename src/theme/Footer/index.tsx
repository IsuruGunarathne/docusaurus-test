...
const communityLinks = [
  {
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" style={{color: '#f48024'}}>
        <path d="M15.725 0l-1.72 1.277 6.39 8.588-6.39 8.589 1.72 1.277 7.277-9.866L15.725 0zm-9.257 1.277L.191 11.143l6.277 9.866 1.72-1.277-5.573-8.589 5.573-8.588-1.463-1.278zM12.03 0h-2.063v24h2.063V0z" opacity="0"/>
        <path d="M17.535 18.093H6.467v1.542h11.068v-1.542zm.816-3.538l-1.433-.315-2.467 11.21 1.434.315 2.466-11.21zm-9.74-.066l-2.467-11.21-1.434.315 2.466 11.21 1.435-.315zm12.36-.529l-.955-1.136-8.646 7.27.956 1.135 8.645-7.27zm-15 .529l-8.645-7.27-.956 1.135 8.645 7.27.956-1.135z"/>
      </svg>
    ),
